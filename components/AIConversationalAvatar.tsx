...
const loadingMessages = [
    ...
    "Aplicando expressões faciais realistas...",
];
    ...
    if (!apiKeySelected) {
        return (
            <div className="h-full flex flex-col justify-center items-center text-center bg-base-200 p-6 rounded-xl shadow-lg animate-fade-in">
                ...
                <p className="text-gray-400 mb-6 max-w-md">Para dar vida aos seus avatares, você precisa selecionar uma chave de API do Google Cloud.</p>
