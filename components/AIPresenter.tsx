...
const loadingMessages = [
    "Preparando o estúdio virtual...",
    "Instruindo o apresentador de IA...",
    "Ajustando luzes, câmera, IA...",
    "Renderizando seu vídeo de marketing...",
    "Seu produto está quase pronto para o estrelato...",
];
    ...
    if (!apiKeySelected) {
        return (
            <div className="h-full flex flex-col justify-center items-center text-center bg-base-200 p-6 rounded-xl shadow-lg animate-fade-in">
                ...
                <p className="text-gray-400 mb-6 max-w-md">Para gerar vídeos com o Apresentador IA, você precisa selecionar uma chave de API do Google Cloud.</p>
                <button
